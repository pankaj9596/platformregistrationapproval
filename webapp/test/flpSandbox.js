		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#usermanagementretailersapprovalrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"usermanagementretailersapprovalrequest-display": {
								"semanticObject": "usermanagementretailersapprovalrequest",
								"action": "display",
